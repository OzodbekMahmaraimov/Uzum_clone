...
import navImg2 from './images/nav-img-2.png';
      ...
      <nav className='nav-bar'>
        ...
        <div className='w-100'>
          <div className='header-md'>
            ...
            <div className='header-item item-4 pointer rounded-2 d-flex align-items-center justify-content-center gap-2 ps-3'>
              ...
              <span data-v-698cad85="" className="action-button__label"> Kirish </span>
            </div>
            <Link className='action' to='/saralangan'>
              <div className='header-item item-5 pointer rounded-2 d-flex align-items-center justify-content-center gap-2'>
                ...
                <span className="action"> Saralangan </span>
              </div>
            </Link>
            <div className='header-item item-6 pointer rounded-2 d-flex align-items-center justify-content-center gap-2'>
              ...
              <span data-v-698cad85="" className="action-button__label slightly"> Savat </span>
            </div>
          </div>
        </div>
        ...
        <div className="navbar ps-0">
          <ul className='ps-0 d-flex align-items-center justify-content-around flex-row w-100'>
            ...
            <li className='d-flex align-items-center gap-2'>
              <img className='logo2' src={navImg2} alt="..." />
              <p className='my-auto fs-13 fw-600 text-dark'>Sirli to'plam</p>
            </li>
